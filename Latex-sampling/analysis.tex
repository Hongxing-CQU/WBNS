...
\subfigure[{ Dart throwing [Wei 2010]}]{
   \includegraphics[width=0.40\textwidth]{figure/2-class-weiliyi.png}
   \label{two-class-sampling-a}
}%
\hspace{0.1in}
\subfigure[{ Our algorithm:$\lambda_{1,2,3}=(1,1,1)/3$}]{
   \includegraphics[width=.40\textwidth]{figure/2-111.png}
   \label{two-class-sampling-a}
}\\
\subfigure[{ Our algorithm:$\lambda_{1,2,3}=(1,1,2)/4$}]{
   \includegraphics[width=.40\textwidth]{figure/2-112.png}
   \label{two-class-sampling-c}
}%
\hspace{0.1in}
\subfigure[{ Our algorithm:$\lambda_{1,2,3}=(1,1,6)/8$}]{
   \includegraphics[width=.40\textwidth]{figure/2-116.png}
}%
...
quarter of the ramp.
It can be shown that our algorithm is comparable to CCVT~\cite{balzer:2009:capacity} and ~\cite{de:2012:blue} for both the cases of constant density and the intensity ramp.
