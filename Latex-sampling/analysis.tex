...
The sampling rate is $1/16$ for every individual class sampling.
 ...
 \multicolumn{3}{c}{ Times(s)} \\ \cline{2-4}
  Class & [Wei 2010] & Our CPU &  Our GPU \\ \hline


 % after \\: \hline or \cline{col1-col2} %\cline{col3-col4}

   2 & 34.769&   242.908 & 14.670  \\ \hline
   3 & 151.727& 665.797 & 37.553   \\ \hline
   7 & 414.031&  13190.018 & 212.133 \\ \hline
...
With the increasing of sampling points or with the decreasing of sampling rate,
our approach outperforms CCVT~\cite{balzer:2009:capacity} and power diagrams~\cite{de:2012:blue}.

 


the time of our approach with other approach.
