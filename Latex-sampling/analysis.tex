...
% 做一个
To evaluate efficiency of relaxing conflicts of desired centroid locations,
we compare our approach with Wei's method~\cite{wei:2010:multi} on the
difference between centroid locations of voronoi diagrams for single class samples and multi-class samples.
